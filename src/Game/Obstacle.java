...
public class Obstacle {
	...
	public boolean checkCollision(float x, float y) {
		...
		// Check the first Obstacle (in the case that there is only one JLabel in the
		// Obstacle)
		if ((x >= posX1 && x <= (posX1 + ObstacleObject[0].getWidth()) && y >= posY1
				&& y <= (posY1 + ObstacleObject[0].getHeight()))) {
			return true;
		}

		// If the Obstacle has 3 JLabels in it (if it's a straight line), check each
		// JLabel.
		if (ObstacleObject.length == 3) {
			if ((x >= posX1 && x <= (posX1 + ObstacleObject[0].getWidth()) && y >= posY1
					&& y <= (posY1 + ObstacleObject[0].getHeight()))
					|| (x >= posX2 && x <= (posX2 + ObstacleObject[1].getWidth()) && y >= posY2
							&& y <= (posY2 + ObstacleObject[1].getHeight()))
					|| (x >= posX3 && x <= (posX3 + ObstacleObject[2].getWidth()) && y >= posY3
							&& y <= (posY3 + ObstacleObject[2].getHeight()))) {
				return true;
			}
			...
			if ((x >= posX1 && x <= (posX1 + ObstacleObject[0].getWidth()) && y >= posY1
					...
					|| (x >= posX3 && x <= (posX3 + ObstacleObject[2].getWidth()) && y >= posY3
							&& y <= (posY3 + ObstacleObject[2].getHeight()))
					|| (x >= posX4 && x <= (posX4 + ObstacleObject[3].getWidth()) && y >= posY4
							&& y <= (posY4 + ObstacleObject[3].getHeight()))
					|| (x >= posX5 && x <= (posX5 + ObstacleObject[4].getWidth()) && y >= posY5
							&& y <= (posY5 + ObstacleObject[4].getHeight()))) {
				return true;
			}
		}
